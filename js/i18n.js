const TRANSLATIONS = {
  es: {
    ...
    stats_listings: "Anuncios activos",
    stats_cities: "Ciudades",
    stats_countries: "Países",
    stats_verified: "% Verificados",
    section_explore: "Explora por tipo",
    section_sub: "Encuentra el inmueble según tus necesidades",
    type_sale: "Venta",
    type_rent: "Alquiler larga duración",
    type_room: "Habitaciones",
    type_commercial: "Locales y naves",
    type_land: "Suelo",
    type_singular: "Activos singulares",
    btn_see_all: "Ver todos",
    sponsors_title: "Espacios de visibilidad premium",
    testimonials_title: "Lo que dicen los anunciantes",
    btn_mas_visibilidad: "Más visibilidad — 29,95 €",
    btn_sensacional: "Sensacional 24h — 14,95 €",
    listing_price: "Precio",
    listing_location: "Ubicación",
    listing_type: "Tipo",
    listing_contact: "Contactar",
    publish_free: "Publicar gratis",
    chany_greeting: "🏡 Hola, soy Chany, tu asistente inmobiliaria",
    free_until: "5 anuncios gratis · Plan Básico 50 · Plan Premium 100",
    badge_featured: "DESTACADO",
    badge_sensacional: "SENSACIONAL",
    badge_new: "NUEVO",
  ...
  en: {
    ...
    section_explore: "Browse by type",
    section_sub: "Find the property that fits your needs",
    type_sale: "For sale",
    type_rent: "Long-term rental",
    type_room: "Rooms",
    type_commercial: "Commercial",
    type_land: "Land",
    type_singular: "Singular assets",
    btn_see_all: "View all",
    sponsors_title: "Premium visibility spaces",
    testimonials_title: "What listers say",
    btn_mas_visibilidad: "More visibility — €29.95",
    btn_sensacional: "Sensational 24h — €14.95",
    listing_price: "Price",
    listing_location: "Location",
    listing_type: "Type",
    listing_contact: "Contact",
    publish_free: "List for free",
    chany_greeting: "🏡 Hi, I'm Chany, your real estate assistant",
    free_until: "Free up to 5 listings · until December 2027",
    badge_featured: "FEATURED",
    badge_sensacional: "SENSATIONAL",
    badge_new: "NEW",
    expires_in: "Expires in",
    days: "days"
  },
  fr: {
    hero_title: "Votre prochain bien est ici",
    hero_sub: "Annonces vérifiées dans toute l'Europe",
    btn_venta: "Biens à vendre",
    btn_alquiler: "Biens à louer",
    nav_venta: "Vente",
    nav_alquiler: "Location",
    nav_publicar: "Publier gratuitement",
    nav_sponsors: "Sponsors",
    footer_desc: "Portail immobilier premium européen.",
    contact_title: "Publier une annonce",
    verified_badge: "PORTAIL VÉRIFIÉ",
    stats_listings: "Annonces actives",
    stats_cities: "Villes",
    stats_countries: "Pays",
    stats_verified: "% Vérifiés",
    section_explore: "Explorer par type",
    section_sub: "Trouvez le bien selon vos besoins",
    type_sale: "Vente",
    type_rent: "Location longue durée",
    type_room: "Chambres",
    type_commercial: "Locaux commerciaux",
    type_land: "Terrain",
    type_singular: "Actifs singuliers",
    btn_see_all: "Voir tout",
    sponsors_title: "Espaces de visibilité premium",
    testimonials_title: "Ce que disent les annonceurs",
    btn_mas_visibilidad: "Plus de visibilité — 29,95 €",
    btn_sensacional: "Sensationnel 24h — 14,95 €",
    listing_price: "Prix",
    listing_location: "Localisation",
    listing_type: "Type",
    listing_contact: "Contacter",
    publish_free: "Publier gratuitement",
    chany_greeting: "🏡 Bonjour, je suis Chany, votre assistante immobilière",
    free_until: "Gratuit jusqu'à 5 biens · jusqu'en décembre 2027",
    badge_featured: "EN VEDETTE",
    badge_sensacional: "SENSATIONNEL",
    badge_new: "NOUVEAU",
    expires_in: "Expire dans",
    days: "jours"
  },
  de: {
    hero_title: "Ihre nächste Immobilie ist hier",
    hero_sub: "Verifizierte Angebote in ganz Europa",
    btn_venta: "Immobilien kaufen",
    btn_alquiler: "Immobilien mieten",
    nav_venta: "Kauf",
    nav_alquiler: "Miete",
    nav_publicar: "Kostenlos inserieren",
    nav_sponsors: "Sponsoren",
    footer_desc: "Premium europäisches Immobilienportal.",
    contact_title: "Inserat aufgeben",
    verified_badge: "VERIFIZIERTES PORTAL",
    stats_listings: "Aktive Inserate",
    stats_cities: "Städte",
    stats_countries: "Länder",
    stats_verified: "% Verifiziert",
    section_explore: "Nach Typ erkunden",
    section_sub: "Finden Sie die passende Immobilie",
    type_sale: "Kaufen",
    type_rent: "Langzeitmiete",
    type_room: "Zimmer",
    type_commercial: "Gewerbe",
    type_land: "Grundstück",
    type_singular: "Besondere Objekte",
    btn_see_all: "Alle anzeigen",
    sponsors_title: "Premium Sichtbarkeit",
    testimonials_title: "Was Inserenten sagen",
    btn_mas_visibilidad: "Mehr Sichtbarkeit — 29,95 €",
    btn_sensacional: "Sensationell 24h — 14,95 €",
    listing_price: "Preis",
    listing_location: "Standort",
    listing_type: "Typ",
    listing_contact: "Kontaktieren",
    publish_free: "Kostenlos inserieren",
    chany_greeting: "🏡 Hallo, ich bin Chany, Ihre Immobilienassistentin",
    free_until: "Bis zu 5 Inserate kostenlos · bis Dezember 2027",
    badge_featured: "EMPFOHLEN",
    badge_sensacional: "SENSATIONELL",
    badge_new: "NEU",
    expires_in: "Läuft ab in",
    days: "Tagen"
  },
  pt: {
    hero_title: "O seu próximo imóvel está aqui",
    hero_sub: "Anúncios verificados em toda a Europa",
    btn_venta: "Imóveis à venda",
    btn_alquiler: "Imóveis para arrendar",
    nav_venta: "Venda",
    nav_alquiler: "Arrendamento",
    nav_publicar: "Publicar grátis",
    nav_sponsors: "Patrocinadores",
    footer_desc: "Portal imobiliário premium europeu.",
    contact_title: "Publicar anúncio",
    verified_badge: "PORTAL VERIFICADO",
    stats_listings: "Anúncios ativos",
    stats_cities: "Cidades",
    stats_countries: "Países",
    stats_verified: "% Verificados",
    section_explore: "Explorar por tipo",
    section_sub: "Encontre o imóvel certo para si",
    type_sale: "Venda",
    type_rent: "Arrendamento longa duração",
    type_room: "Quartos",
    type_commercial: "Comercial",
    type_land: "Terreno",
    type_singular: "Ativos singulares",
    btn_see_all: "Ver todos",
    sponsors_title: "Espaços de visibilidade premium",
    testimonials_title: "O que dizem os anunciantes",
    btn_mas_visibilidad: "Mais visibilidade — 29,95 €",
    btn_sensacional: "Sensacional 24h — 14,95 €",
    listing_price: "Preço",
    listing_location: "Localização",
    listing_type: "Tipo",
    listing_contact: "Contactar",
    publish_free: "Publicar grátis",
    chany_greeting: "🏡 Olá, sou a Chany, a sua assistente imobiliária",
    free_until: "Grátis até 5 imóveis · até dezembro de 2027",
  ...
  it: {
    hero_title: "Il tuo prossimo immobile è qui",
    hero_sub: "Annunci verificati in tutta Europa",
    btn_venta: "Immobili in vendita",
    btn_alquiler: "Immobili in affitto",
    nav_venta: "Vendita",
    nav_alquiler: "Affitto",
    nav_publicar: "Pubblica gratis",
    nav_sponsors: "Sponsor",
    footer_desc: "Portale immobiliare premium europeo.",
    contact_title: "Pubblica annuncio",
    verified_badge: "PORTALE VERIFICATO",
    stats_listings: "Annunci attivi",
    stats_cities: "Città",
    stats_countries: "Paesi",
    stats_verified: "% Verificati",
    section_explore: "Esplora per tipo",
    section_sub: "Trova l'immobile adatto a te",
    type_sale: "Vendita",
    type_rent: "Affitto lungo termine",
    type_room: "Stanze",
    type_commercial: "Commerciale",
    type_land: "Terreno",
    type_singular: "Immobili singolari",
    btn_see_all: "Vedi tutti",
    sponsors_title: "Spazi di visibilità premium",
    testimonials_title: "Cosa dicono gli inserzionisti",
    btn_mas_visibilidad: "Più visibilità — 29,95 €",
    btn_sensacional: "Sensazionale 24h — 14,95 €",
    listing_price: "Prezzo",
    listing_location: "Posizione",
    listing_type: "Tipo",
    listing_contact: "Contatta",
    publish_free: "Pubblica gratis",
    chany_greeting: "🏡 Ciao, sono Chany, la tua assistente immobiliare",
    free_until: "Gratis fino a 5 immobili · fino a dicembre 2027",
    badge_featured: "IN EVIDENZA",
    badge_sensacional: "SENSAZIONALE",
    badge_new: "NUOVO",
    expires_in: "Scade tra",
    days: "giorni"
  },
  ru: {
    hero_title: "Ваша следующая недвижимость здесь",
    hero_sub: "Проверенные объявления по всей Европе",
    btn_venta: "Недвижимость на продажу",
    btn_alquiler: "Аренда недвижимости",
    nav_venta: "Продажа",
    nav_alquiler: "Аренда",
    nav_publicar: "Разместить бесплатно",
    nav_sponsors: "Спонсоры",
    footer_desc: "Премиальный европейский портал недвижимости.",
    contact_title: "Разместить объявление",
    verified_badge: "ПРОВЕРЕННЫЙ ПОРТАЛ",
    stats_listings: "Активных объявлений",
    stats_cities: "Городов",
    stats_countries: "Стран",
    stats_verified: "% Проверено",
    section_explore: "Поиск по типу",
    section_sub: "Найдите подходящую недвижимость",
    type_sale: "Продажа",
    type_rent: "Долгосрочная аренда",
    type_room: "Комнаты",
    type_commercial: "Коммерческая",
    type_land: "Земля",
    type_singular: "Уникальные объекты",
    btn_see_all: "Смотреть все",
    sponsors_title: "Премиальная видимость",
    testimonials_title: "Отзывы пользователей",
    btn_mas_visibilidad: "Больше видимости — 29,95 €",
    btn_sensacional: "Сенсационно 24ч — 14,95 €",
    listing_price: "Цена",
    listing_location: "Местоположение",
    listing_type: "Тип",
    listing_contact: "Связаться",
    publish_free: "Разместить бесплатно",
    chany_greeting: "🏡 Привет, я Чани, ваш помощник по недвижимости",
    free_until: "Бесплатно до 5 объектов · до декабря 2027",
    badge_featured: "FEATURED",
    badge_sensacional: "СЕНСАЦИЯ",
    badge_new: "НОВОЕ",
    expires_in: "Истекает через",
    days: "дней"
  },
  tr: {
    hero_title: "Bir sonraki mülkünüz burada",
    hero_sub: "Tüm Avrupa'da doğrulanmış ilanlar",
    btn_venta: "Satılık mülkler",
    btn_alquiler: "Kiralık mülkler",
    nav_venta: "Satış",
    nav_alquiler: "Kiralık",
    nav_publicar: "Ücretsiz ilan ver",
    nav_sponsors: "Sponsorlar",
    footer_desc: "Premium Avrupa gayrimenkul portalı.",
    contact_title: "İlan ver",
    verified_badge: "DOĞRULANMIŞ PORTAL",
    stats_listings: "Aktif ilanlar",
    stats_cities: "Şehirler",
    stats_countries: "Ülkeler",
    stats_verified: "% Doğrulanmış",
    section_explore: "Türe göre ara",
    section_sub: "İhtiyacınıza uygun mülkü bulun",
    type_sale: "Satılık",
    type_rent: "Uzun süreli kiralık",
    type_room: "Odalar",
    type_commercial: "Ticari",
    type_land: "Arazi",
    type_singular: "Özel mülkler",
    btn_see_all: "Tümünü gör",
    sponsors_title: "Premium görünürlük alanları",
    testimonials_title: "İlan sahiplerinin yorumları",
    btn_mas_visibilidad: "Daha fazla görünürlük — 29,95 €",
    btn_sensacional: "Muhteşem 24s — 14,95 €",
    listing_price: "Fiyat",
    listing_location: "Konum",
    listing_type: "Tür",
    listing_contact: "İletişim",
    publish_free: "Ücretsiz ilan ver",
    chany_greeting: "🏡 Merhaba, ben Chany, gayrimenkul asistanınızım",
    free_until: "5 ilana kadar ücretsiz · Aralık 2027'ye kadar",
    badge_featured: "ÖNE ÇIKAN",
    badge_sensacional: "MUHTEŞEM",
    badge_new: "YENİ",
    expires_in: "Süresi doluyor",
    days: "gün"
  },
  ar: {
    hero_title: "عقارك القادم هنا",
    hero_sub: "إعلانات موثقة في جميع أنحاء أوروبا",
    btn_venta: "عقارات للبيع",
    btn_alquiler: "عقارات للإيجار",
    nav_venta: "بيع",
    nav_alquiler: "إيجار",
    nav_publicar: "نشر مجاناً",
    nav_sponsors: "الرعاة",
    footer_desc: "بوابة عقارية أوروبية متميزة.",
    contact_title: "نشر إعلان",
    verified_badge: "بوابة موثقة",
    stats_listings: "إعلانات نشطة",
    stats_cities: "مدن",
    stats_countries: "دول",
    stats_verified: "% موثق",
    section_explore: "تصفح حسب النوع",
    section_sub: "اعثر على العقار المناسب لك",
    type_sale: "للبيع",
    type_rent: "إيجار طويل الأمد",
    type_room: "غرف",
    type_commercial: "تجاري",
    type_land: "أراضي",
    type_singular: "عقارات مميزة",
    btn_see_all: "عرض الكل",
    sponsors_title: "مساحات ظهور متميزة",
    testimonials_title: "ماذا يقول المعلنون",
    btn_mas_visibilidad: "مزيد من الظهور — 29.95 €",
    btn_sensacional: "رائع 24 ساعة — 14.95 €",
    listing_price: "السعر",
    listing_location: "الموقع",
    listing_type: "النوع",
    listing_contact: "تواصل",
    publish_free: "نشر مجاناً",
    chany_greeting: "🏡 مرحباً، أنا تشاني، مساعدتك العقارية",
    free_until: "مجاني حتى 5 عقارات · حتى ديسمبر 2027",
    badge_featured: "مميز",
    badge_sensacional: "رائع",
    badge_new: "جديد",
    expires_in: "ينتهي خلال",
    days: "أيام"
  },
  zh: {
    hero_title: "您的下一处房产就在这里",
    hero_sub: "遍布欧洲的认证房源",
    btn_venta: "出售房产",
    btn_alquiler: "出租房产",
    nav_venta: "出售",
    ...
    stats_countries: "国家",
    stats_verified: "% 已认证",
    section_explore: "按类型浏览",
    section_sub: "找到适合您的房产",
    type_sale: "出售",
    type_rent: "长期出租",
    type_room: "房间",
    type_commercial: "商业地产",
    type_land: "土地",
    type_singular: "特色房产",
    btn_see_all: "查看全部",
    sponsors_title: "优质曝光位置",
    testimonials_title: "房东怎么说",
    btn_mas_visibilidad: "更多曝光 — 29.95 €",
    btn_sensacional: "精选24小时 — 14.95 €",
    listing_price: "价格",
    listing_location: "位置",
    listing_type: "类型",
    listing_contact: "联系",
    publish_free: "免费发布",
    chany_greeting: "🏡 您好，我是Chany，您的房产助手",
    free_until: "最多5套免费 · 直到2027年12月",
    badge_featured: "推荐",
    badge_sensacional: "精选",
    badge_new: "新上",
    expires_in: "到期时间",
    days: "天"
  }
...
const LITERAL_TEXT = {
  en: {
    ...
    'neuralgpt.store es un portal inmobiliario premium europeo activo, centrado en venta y alquiler estable.': 'neuralgpt.store is a premium European real estate portal in operation, focused on sales and long-term rentals.',
    ...
    'Este sitemap enlaza únicamente rutas públicas canónicas operational para mantener una identidad única y una indexación limpia.': 'This sitemap links only canonical public phase-1 routes to maintain a single identity and clean indexation.',
    ...
    ,'Venta inmobiliaria en Europa | neuralgpt.store': 'Real estate sales in Europe | neuralgpt.store'
    ,'Venta inmobiliaria en Europa': 'Real estate sales in Europe'
    ,'Explora activos de compraventa con lectura editorial y rutas de mercado activas. El contacto directo del anunciante se desbloquea tras pago del servicio de conexión en cada ficha.': 'Explore sale assets with editorial context and active market routes. Direct advertiser contact is unlocked after paying the connection service on each listing.'
    ,'Mercados con tracción': 'High-traction markets'
    ,'Madrid, Lisboa y Milán concentran actividad y rotación de activos para compraventa residencial y singular.': 'Madrid, Lisbon, and Milan concentrate activity and asset rotation for residential and singular sales.'
    ,'Operativa comercial': 'Commercial operations'
    ,'Publicación manual, revisión editorial y opciones de visibilidad para anunciantes profesionales o particulares.': 'Manual publishing, editorial review, and visibility options for professional or private advertisers.'
    ,'Acción directa': 'Direct action'
    ,'Si no ves aún el activo exacto, activa alerta o publica tu inmueble desde contacto.': 'If you still do not see the exact asset, activate an alert or publish your property from contact.'
    ,'Alquiler estable en Europa | neuralgpt.store': 'Long-term rent in Europe | neuralgpt.store'
    ,'Alquiler estable y larga estancia': 'Long-term and stable rent'
    ,'Ruta orientada a alquiler residencial y habitación en mercados europeos con demanda activa. El acceso a contacto del anunciante se activa tras pago del servicio de conexión en la ficha.': 'Route focused on residential rent and rooms in European markets with active demand. Advertiser contact access is enabled after paying the connection service on the listing.'
    ,'Modalidad operativa': 'Operational mode'
    ,'Alquiler estable y habitación de larga estancia con foco en claridad de condiciones y precio mensual.': 'Stable rental and long-stay room inventory focused on clear conditions and monthly pricing.'
    ,'Cobertura prioritaria': 'Priority coverage'
    ,'Madrid, Lisboa, Berlín y Valencia como plazas de referencia para demanda internacional y movilidad profesional.': 'Madrid, Lisbon, Berlin, and Valencia as reference markets for international demand and professional mobility.'
    ,'Siguiente paso': 'Next step'
    ,'Si quieres publicar, reforzar visibilidad o activar alertas de nuevas fichas, utiliza contacto del portal.': 'If you want to publish, boost visibility, or activate alerts for new listings, use the portal contact.'
    ,'Portal inmobiliario europeo | neuralgpt.store': 'European real estate portal | neuralgpt.store'
    ,'Entrada inmobiliaria premium': 'Premium real estate entrypoint'
    ,'Acceso rápido a colecciones, hubs editoriales y rutas de conversión. Modelo comercial alineado: publicación verificable y desbloqueo de contacto tras pago por ficha.': 'Fast access to collections, editorial hubs, and conversion routes. Aligned business model: verifiable publishing and contact unlock after per-listing payment.'
    ,'Rutas comerciales': 'Commercial routes'
    ,'Landing por operación, colecciones por país y ciudad, y fichas listas para activación E2E con backend.': 'Operation landing pages, country/city collections, and listings ready for E2E activation with backend.'
    ,'Calidad editorial': 'Editorial quality'
    ,'Texto y navegación diseñados para evitar ruido de maqueta y mantener percepción de portal europeo real.': 'Copy and navigation designed to avoid mockup noise and maintain the feel of a real European portal.'
    ,'Activación operativa': 'Operational activation'
    ,'Al activar backend y Stripe reales, esta superficie ya queda preparada para operar sin contradicciones de producto.': 'Once real backend and Stripe are enabled, this surface is ready to operate without product contradictions.'
    ,'Blog Inmobiliario neuralgpt.store | Guías y Consejos Expertos': 'neuralgpt.store Real Estate Blog | Expert Guides and Advice'
    ,'Blog Inmobiliario': 'Real Estate Blog'
    ,'Guías prácticas, consejos expertos y análisis de mercado para comprar, alquilar e invertir en inmuebles en Europa.': 'Practical guides, expert advice, and market analysis to buy, rent, and invest in properties in Europe.'
    ,'Guía Completa para Comprar Piso en Europa 2026 | neuralgpt.store Blog': 'Complete Guide to Buying an Apartment in Europe 2026 | neuralgpt.store Blog'
    ,'Alquiler Larga Duración en Europa: Guía 2026 | neuralgpt.store Blog': 'Long-Term Rent in Europe: 2026 Guide | neuralgpt.store Blog'
    ,'Guía Completa para Comprar Piso en Europa 2026': 'Complete Guide to Buying an Apartment in Europe 2026'
    ,'Todo lo que necesitas saber para comprar vivienda en Europa: países recomendados, precios, fiscalidad y proceso de compra paso a paso.': 'Everything you need to know to buy property in Europe: recommended countries, prices, taxation, and a step-by-step purchase process.'
    ,'Países recomendados, precios, fiscalidad y proceso de compra paso a paso para adquirir vivienda en Europa.': 'Recommended countries, prices, taxation, and a step-by-step process to acquire housing in Europe.'
    ,'Alquiler Larga Duración en Europa: Guía 2026': 'Long-Term Rent in Europe: 2026 Guide'
    ,'Precios, contratos, derechos del inquilino y las mejores ciudades europeas para alquilar vivienda en 2026.': 'Prices, contracts, tenant rights, and the best European cities to rent housing in 2026.'
    ,'Precios, contratos, derechos del inquilino y mejores ciudades para alquilar vivienda en Europa.': 'Prices, contracts, tenant rights, and top cities to rent housing in Europe.'
